---
name: setup-vendre
description: Deterministic setup for connecting a Lovable storefront to a Vendre Surface v2 store. Use when the user runs /setup-vendre, asks to connect the storefront to Vendre, provides Vendre API keys, or reports CORS/401/429 errors during Vendre onboarding. Blocks storefront UI work until the connection test passes.
---
