...
Målet med denna butik är att den ska vara uppbyggd utifrån Vendres API, men ifall Kopplingen till Vendre inte fungerar så ska dummy data finnas så att butiken inte går sönder. Denna butik kommer agera start template för nya Lovable projekt som kommer att importera in detta repo. När Repot importeras in i ett nytt projekt så  ska det ha rätt filtruktur från början så att strukturen int ebehöver byggas om - endast dummy data kommer att bytas ut mot den riktiga datan från Vendre.
