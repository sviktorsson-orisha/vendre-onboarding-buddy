...
Dummy-datan byts ut först när guiden är helt verifierad, eftersom riktig data i webbläsaren kräver att CORS är korrekt upplagt. Att bara ha sparat nycklarna räcker inte längre för att slå över.

## 4. "Börja bygga butiken" tar bort bannern

Klick på knappen stänger popupen och tar bort toppbannern direkt, oavsett hur guiden ser ut i övrigt. Den kommer inte tillbaka vid reload.
