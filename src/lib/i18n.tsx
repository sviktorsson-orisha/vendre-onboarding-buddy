...
const dictionary = {
  sv: {
    ...
    "store.home": "Start",
    "store.sort": "Sortera",
    "store.sortNameAsc": "Namn A–Ö",
    "store.sortNameDesc": "Namn Ö–A",
    "store.sortPriceAsc": "Pris lågt–högt",
    "store.sortPriceDesc": "Pris högt–lågt",
    "store.perPage": "Per sida",
  ...
  en: {
    ...
    "store.sortNameDesc": "Name Z–A",
    "store.sortPriceAsc": "Price low–high",
    "store.sortPriceDesc": "Price high–low",
