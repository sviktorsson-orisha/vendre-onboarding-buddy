...
const dictionary = {
  sv: {
    ...
    "notice.badge": "Demo Mode (Dummy Data)",
    "notice.text":
      "Du kör just nu med dummy-data. Koppla ditt Vendre-konto för att aktivera din live-butik.",
    "notice.action": "Starta uppstartsguide",
    "notice.dialogTitle": "Uppstartsguide",
    "cart.title": "Kundvagn",
    "cart.empty": "Kundvagnen är tom.",
    "cart.increase": "Öka antal",
    "cart.decrease": "Minska antal",
    "cart.remove": "Ta bort",
    "cart.totalInclVat": "Totalt (inkl. moms)",
    "cart.totalExclVat": "Totalt (exkl. moms)",
    "cart.checkout": "Till kassan",
    "cart.demoNotice": "Kassan aktiveras när butiken är kopplad till Vendre.",
    "store.searchPlaceholder": "Sök produkter",
    "store.heroEyebrow": "Ny säsong",
    "store.heroTitle": "Handla nyheter och favoriter",
    "store.heroIntro":
      "Ett komplett storefront-skal byggt på Vendre Surface API v2 — redo att fyllas med din butiksdata.",
    "store.heroCta": "Börja handla",
    "store.featured": "Utvalda produkter",
    "store.categories": "Kategorier",
    "store.subcategories": "{count} underkategorier",
    "store.browse": "Visa alla",
    "store.home": "Start",
    "store.loading": "Laddar…",
    "store.sort": "Sortering",
    "store.sortName": "Namn A–Ö",
    "store.sortPriceAsc": "Pris lågt till högt",
    "store.sortPriceDesc": "Pris högt till lågt",
    "store.productCount": "{count} produkter",
    "store.noProducts": "Inga produkter i den här kategorin.",
    "store.inStock": "I lager",
    "store.outOfStock": "Slut i lager",
    "store.variant": "Variant",
    "store.addToCart": "Lägg i varukorg",
    "footer.service": "Kundservice",
    "footer.info": "Information",
    "footer.contact": "Kontakta oss",
    "footer.shipping": "Frakt & leverans",
    "footer.returns": "Retur & byte",
    "footer.faq": "Vanliga frågor",
    "footer.about": "Om oss",
    "footer.terms": "Köpvillkor",
    "footer.privacy": "Integritetspolicy",
    "footer.cookies": "Cookies",
    "footer.payment": "Betalsätt",
    "footer.tagline": "Headless storefront på Vendre Surface API v2.",
    "footer.copyright": "© Vendre Storefront",
  },
  en: {
    "brand.tagline": "Storefront setup",
    "brand.footer": "Headless storefront setup",
    ...
    "notice.badge": "Demo Mode (Dummy Data)",
    "notice.text":
      "You are running on dummy data. Connect your Vendre account to activate your live store.",
    "notice.action": "Start setup guide",
    "notice.dialogTitle": "Setup guide",
    "cart.title": "Cart",
    "cart.empty": "Your cart is empty.",
    "cart.increase": "Increase quantity",
    "cart.decrease": "Decrease quantity",
    "cart.remove": "Remove",
    "cart.totalInclVat": "Total (incl. VAT)",
    "cart.totalExclVat": "Total (excl. VAT)",
    "cart.checkout": "Go to checkout",
    "cart.demoNotice": "Checkout is enabled once the store is connected to Vendre.",
    "store.searchPlaceholder": "Search products",
    "store.heroEyebrow": "New season",
    "store.heroTitle": "Shop new arrivals and favourites",
    "store.heroIntro":
      "A complete storefront shell built on Vendre Surface API v2 — ready for your store data.",
    "store.heroCta": "Start shopping",
    "store.featured": "Featured products",
    "store.categories": "Categories",
    "store.subcategories": "{count} subcategories",
    "store.browse": "View all",
    "store.home": "Home",
    "store.loading": "Loading…",
    "store.sort": "Sorting",
    "store.sortName": "Name A–Z",
    "store.sortPriceAsc": "Price low to high",
    "store.sortPriceDesc": "Price high to low",
    "store.productCount": "{count} products",
    "store.noProducts": "No products in this category.",
    ...
    "footer.tagline": "Headless storefront on Vendre Surface API v2.",
    "footer.copyright": "© Vendre Storefront",
  },
} as const;
