...
const dictionary = {
  sv: {
    ...
    "account.typeLocked": "Kundtypen kan bara ändras av butiken – kontakta kundtjänst.",
  ...
  en: {
    ...
    "account.email": "Email",
    "account.typeLocked": "The customer type can only be changed by the store – contact support.",
